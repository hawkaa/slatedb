...
impl DbReaderInner {
    ...
    /// corrects any mismatches. This handles two cases:
    /// 1. Legacy manifest entries with sentinel value 0 (no format_version field)
    /// 2. Manifest entries corrupted by a bug that wrote the wrong default version
